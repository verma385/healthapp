          ...
          <div className="row g-0">
            <div className="col-lg-6">
              <div className="card-body p-md-5 mx-md-4">
                ...
                <div className="text-center">
                  ...
                  <h4 className="mt-1 mb-5 pb-1">Connect with us</h4>
                </div>
            ...
            <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 className="mb-4">We are here for you !!</h4>
                <p className="small mb-0">Login to your account and we will be here for you. Track your health, upload your records, find doctors and 
                book appointments. Never take your health for granted. </p>
              </div>
            </div>
          </div>
        </div>
